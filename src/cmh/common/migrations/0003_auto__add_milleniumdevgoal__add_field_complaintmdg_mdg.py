...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MilleniumDevGoal'
        db.create_table('common_milleniumdevgoal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('goalnum', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal('common', ['MilleniumDevGoal'])

        # Adding field 'ComplaintMDG.mdg'
        db.add_column('common_complaintmdg', 'mdg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MilleniumDevGoal'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MilleniumDevGoal'
        db.delete_table('common_milleniumdevgoal')

        # Deleting field 'ComplaintMDG.mdg'
        db.delete_column('common_complaintmdg', 'mdg_id')
    ...
    models = {
        ...
        'common.complaintmdg': {
            'Meta': {'object_name': 'ComplaintMDG'},
            'complainttype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.ComplaintType']"}),
            'goalnum': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mdg': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.MilleniumDevGoal']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'common.milleniumdevgoal': {
            'Meta': {'object_name': 'MilleniumDevGoal'},
            'goalnum': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'common.state': {
