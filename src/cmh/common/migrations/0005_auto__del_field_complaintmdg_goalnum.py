...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ComplaintMDG.goalnum'
        db.delete_column('common_complaintmdg', 'goalnum')


    def backwards(self, orm):
        
        # Adding field 'ComplaintMDG.goalnum'
        db.add_column('common_complaintmdg', 'goalnum', self.gf('django.db.models.fields.CharField')(default=None, max_length=20), keep_default=False)
