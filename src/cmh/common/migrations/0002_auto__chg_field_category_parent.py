...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('common_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Category'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Category.parent'
        db.alter_column('common_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Category']))
