...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_menuitem', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MenuItem'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuItem.parent'
        db.delete_column('common_menuitem', 'parent_id')
    ...
    models = {
        ...
        'common.menuitem': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.MenuItem']", 'null': 'True', 'blank': 'True'}),
