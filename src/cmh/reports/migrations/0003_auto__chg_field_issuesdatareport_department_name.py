...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reports_issuesdatareport', 'department_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'reports.issuesdatareport': {
            ...
            'department_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
