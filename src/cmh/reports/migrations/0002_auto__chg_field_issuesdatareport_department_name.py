...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssuesDataReport.department_name'
        db.alter_column('reports_issuesdatareport', 'department_name', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

    def backwards(self, orm):

        # Changing field 'IssuesDataReport.department_name'
        db.alter_column('reports_issuesdatareport', 'department_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'reports.issuesdatareport': {
            ...
            'department_name': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'null': 'True', 'blank': 'True'}),
