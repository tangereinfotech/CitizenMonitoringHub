...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Official', fields ['departments']
        db.delete_unique('usermgr_official', ['departments_id'])

        # Changing field 'Official.departments'
        db.alter_column('usermgr_official', 'departments_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.ComplaintDepartment'], null=True))

        # Adding unique constraint on 'Official', fields ['supervisor', 'departments']
        db.create_unique('usermgr_official', ['supervisor_id', 'departments_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Official', fields ['supervisor', 'departments']
        db.delete_unique('usermgr_official', ['supervisor_id', 'departments_id'])

        # Changing field 'Official.departments'
        db.alter_column('usermgr_official', 'departments_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.ComplaintDepartment'], unique=True, null=True))

        # Adding unique constraint on 'Official', fields ['departments']
        db.create_unique('usermgr_official', ['departments_id'])
    ...
    models = {
        ...
        'usermgr.official': {
            'Meta': {'unique_together': "(('supervisor', 'departments'),)", 'object_name': 'Official'},
            ...
            'departments': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.ComplaintDepartment']", 'null': 'True', 'blank': 'True'}),
