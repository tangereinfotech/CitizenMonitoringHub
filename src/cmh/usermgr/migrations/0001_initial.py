...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('usermgr_menuitem', ['role_id', 'serial', 'url'])
        ...
        # Adding M2M table for field complainttypes on 'Official'
        db.create_table('usermgr_official_complainttypes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('official', models.ForeignKey(orm['usermgr.official'], null=False)),
            ('complainttype', models.ForeignKey(orm['common.complainttype'], null=False))
        ))
        db.create_unique('usermgr_official_complainttypes', ['official_id', 'complainttype_id'])


    def backwards(self, orm):

        # Removing unique constraint on 'MenuItem', fields ['role', 'serial', 'url']
        db.delete_unique('usermgr_menuitem', ['role_id', 'serial', 'url'])
        ...
        # Removing M2M table for field complainttypes on 'Official'
        db.delete_table('usermgr_official_complainttypes')
