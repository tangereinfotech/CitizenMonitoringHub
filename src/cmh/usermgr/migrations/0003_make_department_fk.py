...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for official in orm ['usermgr.Official'].objects.all ():
            print "Migration departments for official : %s" % (official.user.username)
            depts = official.departments.all ()
            if depts.count () != 0:
                official.department = depts [0]
                official.save ()
    ...
    models = {
        ...
        'usermgr.official': {
            ...
            'departments': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'departments'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['common.ComplaintDepartment']"}),
