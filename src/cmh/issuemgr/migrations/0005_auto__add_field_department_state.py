...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('issuemgr_department', 'state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issuemgr.State'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Department.state'
        db.delete_column('issuemgr_department', 'state_id')
    ...
    models = {
        ...
        'issuemgr.department': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issuemgr.State']", 'null': 'True', 'blank': 'True'})
        },
        'issuemgr.district': {
