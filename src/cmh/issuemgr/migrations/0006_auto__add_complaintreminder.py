...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ComplaintReminder'
        db.create_table('issuemgr_complaintreminder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('complaintno', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('reminderon', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('issuemgr', ['ComplaintReminder'])


    def backwards(self, orm):
        
        # Deleting model 'ComplaintReminder'
        db.delete_table('issuemgr_complaintreminder')
