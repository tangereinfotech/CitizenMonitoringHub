...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Complaint.latest'
        db.add_column('issuemgr_complaint', 'latest', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Complaint.latest'
        db.delete_column('issuemgr_complaint', 'latest')
