...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('issuemgr_complaint', 'source')

        # Adding field 'Complaint.cardstatus'
        db.add_column('issuemgr_complaint', 'cardstatus',
                      self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Complaint.landpossession'
        db.add_column('issuemgr_complaint', 'landpossession',
                      self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Complaint.jobcategory'
        db.add_column('issuemgr_complaint', 'jobcategory',
                      self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Complaint.shgstatus'
        db.add_column('issuemgr_complaint', 'shgstatus',
                      self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('issuemgr_complaint', 'source',
                      self.gf('django.db.models.fields.CharField')(default='ONLINECITIZEN', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Complaint.cardstatus'
        db.delete_column('issuemgr_complaint', 'cardstatus')

        # Deleting field 'Complaint.landpossession'
        db.delete_column('issuemgr_complaint', 'landpossession')

        # Deleting field 'Complaint.jobcategory'
        db.delete_column('issuemgr_complaint', 'jobcategory')

        # Deleting field 'Complaint.shgstatus'
        db.delete_column('issuemgr_complaint', 'shgstatus')
