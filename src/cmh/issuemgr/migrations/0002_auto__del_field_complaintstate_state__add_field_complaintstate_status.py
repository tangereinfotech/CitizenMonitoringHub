...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ComplaintState.state'
        db.delete_column('issuemgr_complaintstate', 'state')

        # Adding field 'ComplaintState.status'
        db.add_column('issuemgr_complaintstate', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'ComplaintState.state'
        raise RuntimeError(
            "Cannot reverse this migration. 'ComplaintState.state' and its values cannot be restored.")

        # Deleting field 'ComplaintState.status'
        db.delete_column('issuemgr_complaintstate', 'status')
