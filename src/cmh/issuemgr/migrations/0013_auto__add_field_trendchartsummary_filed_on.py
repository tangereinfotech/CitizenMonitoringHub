...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrendChartSummary.filed_on'
        db.add_column('issuemgr_trendchartsummary', 'filed_on',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2000, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrendChartSummary.filed_on'
        db.delete_column('issuemgr_trendchartsummary', 'filed_on')
    ...
    models = {
        ...
        'issuemgr.trendchartsummary': {
            ...
            'filed_on': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
