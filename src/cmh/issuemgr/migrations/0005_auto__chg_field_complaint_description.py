...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Complaint.description'
        db.alter_column('issuemgr_complaint', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'Complaint.description'
        db.alter_column('issuemgr_complaint', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
