...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Complaint.creator'
        db.add_column('issuemgr_complaint', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Complaint.comment'
        db.add_column('issuemgr_complaint', 'comment', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Complaint.creator'
        db.delete_column('issuemgr_complaint', 'creator_id')

        # Deleting field 'Complaint.comment'
        db.delete_column('issuemgr_complaint', 'comment')
