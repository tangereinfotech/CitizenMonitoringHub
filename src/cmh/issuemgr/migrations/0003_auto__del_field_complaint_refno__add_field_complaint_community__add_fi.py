...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Complaint.refno'
        db.delete_column('issuemgr_complaint', 'refno')

        # Adding field 'Complaint.community'
        db.add_column('issuemgr_complaint', 'community', self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Complaint.gender'
        db.add_column('issuemgr_complaint', 'gender', self.gf('django.db.models.fields.CharField')(default='Unspecified', max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Complaint.refno'
        db.add_column('issuemgr_complaint', 'refno', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True), keep_default=False)

        # Deleting field 'Complaint.community'
        db.delete_column('issuemgr_complaint', 'community')

        # Deleting field 'Complaint.gender'
        db.delete_column('issuemgr_complaint', 'gender')
