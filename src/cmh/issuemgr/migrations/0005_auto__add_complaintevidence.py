...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ComplaintEvidence'
        db.create_table('issuemgr_complaintevidence', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('evfile', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ...
        db.send_create_signal('issuemgr', ['ComplaintEvidence'])

        # Adding M2M table for field evidences on 'Complaint'
        db.create_table('issuemgr_complaint_evidences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('complaint', models.ForeignKey(orm['issuemgr.complaint'], null=False)),
            ('complaintevidence', models.ForeignKey(orm['issuemgr.complaintevidence'], null=False))
        ))
        db.create_unique('issuemgr_complaint_evidences', ['complaint_id', 'complaintevidence_id'])


    def backwards(self, orm):
        
        # Deleting model 'ComplaintEvidence'
        db.delete_table('issuemgr_complaintevidence')

        # Removing M2M table for field evidences on 'Complaint'
        db.delete_table('issuemgr_complaint_evidences')
