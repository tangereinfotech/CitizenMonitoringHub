...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ComplaintClosureMetric'
        db.create_table('issuemgr_complaintclosuremetric', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('complaintno', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('closed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('period', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('issuemgr', ['ComplaintClosureMetric'])


    def backwards(self, orm):
        
        # Deleting model 'ComplaintClosureMetric'
        db.delete_table('issuemgr_complaintclosuremetric')
