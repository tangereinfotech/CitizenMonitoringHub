...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Complaint.createdate'
        db.add_column('issuemgr_complaint', 'createdate', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 6, 2), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Complaint.createdate'
        db.delete_column('issuemgr_complaint', 'createdate')
