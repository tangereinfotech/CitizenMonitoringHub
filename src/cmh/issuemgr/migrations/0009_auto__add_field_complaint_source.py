...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('issuemgr_complaint', 'source', self.gf('django.db.models.fields.CharField')(default='ONLINECITIZEN', max_length=20, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'issuemgr.complaint': {
            ...
            'source': ('django.db.models.fields.CharField', [], {'default': "'ONLINECITIZEN'", 'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
