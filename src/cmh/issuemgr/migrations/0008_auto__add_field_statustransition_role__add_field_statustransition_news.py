...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatusTransition.role'
        db.add_column('issuemgr_statustransition', 'role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usermgr.AppRole'], null=True, blank=True), keep_default=False)

        # Adding field 'StatusTransition.newstate'
        db.add_column('issuemgr_statustransition', 'newstate', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='newstate', null=True, to=orm['common.Attribute']), keep_default=False)

        # Removing M2M table for field newstates on 'StatusTransition'
        db.delete_table('issuemgr_statustransition_newstates')

        # Changing field 'StatusTransition.curstate'
        db.alter_column('issuemgr_statustransition', 'curstate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['common.Attribute']))


    def backwards(self, orm):
        
        # Deleting field 'StatusTransition.role'
        db.delete_column('issuemgr_statustransition', 'role_id')

        # Deleting field 'StatusTransition.newstate'
        db.delete_column('issuemgr_statustransition', 'newstate_id')
        ...
        # Changing field 'StatusTransition.curstate'
        db.alter_column('issuemgr_statustransition', 'curstate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Attribute']))
