...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrendChartSummary.department'
        db.add_column('issuemgr_trendchartsummary', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.ComplaintDepartment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrendChartSummary.department'
        db.delete_column('issuemgr_trendchartsummary', 'department_id')
